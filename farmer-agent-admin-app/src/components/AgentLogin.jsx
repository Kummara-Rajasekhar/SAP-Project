            ...
            <div className="brand-content">
              <div className="brand-header animate__animated animate__fadeInDown">
                ...
                <p className="lead text-white-50 mb-5">
                  Access your expert dashboard to provide guidance, share knowledge, and earn by helping farmers.
                </p>
                ...
                <div className="features-list">
                  <div className="feature-item animate__animated animate__fadeInLeft" style={{ animationDelay: '0.2s' }}>
                    ...
                    <span>Farmer Consultations & Expert Advice</span>
                  </div>
            ...
            <div className="login-form-container animate__animated animate__fadeInUp">
              <div className="text-center mb-4">
                ...
                <div className="role-badge mb-4">
                  ...
                  <h2 className="role-title mb-2">Agent Login</h2>
                  <p className="role-description text-muted">
                    Access your expert dashboard and tools
                  </p>
                </div>
              </div>
              ...
              <div className="login-card">
                ...
                <div className="text-center">
                  <p className="text-muted mb-0">
                    ...
                    <a href="/agent-signup" className="text-decoration-none text-primary ms-1 fw-bold">
                      Sign up as Agent
                    </a>
                  </p>
                </div>
                ...
                <div className="demo-credentials mt-4">
                  <div className="alert alert-info">
                    ...
                    <p className="mb-1 small">Email: <code>agent@test.com</code></p>
